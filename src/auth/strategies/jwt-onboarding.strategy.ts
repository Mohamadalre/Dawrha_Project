...
@Injectable()
export class JwtOnboardingStrategy extends PassportStrategy(Strategy,'jwtOnboarding') {
  constructor(
  ...
  async validate(payload: any) {
    ...
    if (!account ||account.accountStatus !== AccountStatus.PENDING_PROFILE|| !account.isEmailVerified) {
